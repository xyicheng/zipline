...
def _load_extensions(default, extensions, strict, environ):
    ...
    if default:
        ...
        extensions.insert(0, default_extension_path)
...
def run_algorithm(start,
    ...
    handle_data : callable[(context, BarData) -> None]
    ...
    default_extension : bool, optional
        Should the default zipline extenstion be loaded. This is found at
        ``$ZIPLINE_ROOT/extenstion.py``
    ...
    See Also
    --------
    zipline.data.bundles : The available data bundles.
    """
    _load_extensions(default_extension, extensions, strict_extensions, environ)
